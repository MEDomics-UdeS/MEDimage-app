...
class Pipeline:
    ...
    def __init__(self, nodes: List[Node], id: int, name: str) -> None:
        ...
        # Dictionary that contains the parameters of the image processing pipeline in the format used by MEDiml.
        self.im_params = MEDiml.utils.json_utils.load_json(JSON_SETTINGS_PATH)  # Loading default settings from MEDimlApp json file as im_params
