...
class MEDimlExtraction:
    ...
    def get_3d_view(self) -> dict:
        ...
        try:
            ...
            if extraction_workflow:
                ...
                # If the node is an input node, and is not yet in the extraction workflow, use the file name to load the MEDiml object directly
                ...
                # Load and store MEDiml instance from file loaded
    ...
    def get_upload(self) -> dict:
        """
        Gets the MEDiml associated with the file or folder and saves it to the UPLOAD_FOLDER.
        ...
        try:
            ...
            if file_type == "folder":
                ...
                dm = MEDiml.wrangling.DataManager(path_to_dicoms=file, path_save=UPLOAD_FOLDER, n_batch=2, save=True)
            ...
            if file and allowed_pickle_object(file):
                ...
                # If the file is a .npy object and therefore has been processed by MEDiml, copy it to the UPLOAD_FOLDER
                if file_type == "file":
                    shutil.copy2(file, file_path)

                # Load the MEDiml pickle object to get the list of ROIs associated
                with open(file_path, 'rb') as f:
                    medscan = pickle.load(f)
                medscan = MEDiml.MEDscan(medscan)
    ...
    def run_be(self) -> dict:
        ...
        try:
            ...
            be = MEDiml.biomarkers.BatchExtractor(
                path_read=path_read,
                path_csv=path_csv,
