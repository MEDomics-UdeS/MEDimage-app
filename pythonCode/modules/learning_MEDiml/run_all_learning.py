...
from med_libs.MEDimlLearning.MEDimlLearning import MEDimlLearning
...
go_print("running MEDiml run_all_learning.py:" + id_)


class GoExecScriptRunMEDimlMlExperiment(GoExecutionScript):
    """
    ...
    def _custom_process(self, json_config: dict) -> dict:
        ...
        # Instanciate the MEDimlLearning object
        self.current_experiment = MEDimlLearning(json_config)
...
def save_experiment(experiment: MEDimlLearning):
    """
