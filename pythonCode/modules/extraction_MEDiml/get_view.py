...
go_print("running MEDiml get_view.py:" + id_)
...
class GoExecScriptRunExperiment(GoExecutionScript):
    ...
    def _custom_process(self, json_config: dict) -> dict:
        ...
        self.current_experiment = MEDimlExtraction(json_config)
        results_pipeline = self.current_experiment.get_3d_view()
        return results_pipeline


def save_experiment(experiment: MEDimlExtraction):
    """
...
get_view = GoExecScriptRunExperiment(json_params_dict)
get_view.start()
